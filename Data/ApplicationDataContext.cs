    ...
    public class ApplicationDataContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Turebi>().HasData(
                ...
                new Turebi { id = 4, Name = "Los-Angeles, CA", Description = "მაგარიი პონტიიი", Price = 15555, image_name = "ee2aa1e4-37d6-41e1-a3b5-ee7d35f0202d.jpg" },
                new Turebi { id = 5, Name = "Italy", Description = "მაგარიი პონტიიი", Price = 12341, image_name = "bffe2b9f-956c-41a5-a72e-12b08c899a45.jpg" },
                new Turebi { id = 6, Name = "Brazil", Description = "მაგარიი პონტიიი", Price = 15111, image_name = "b373e51c-0ba1-4f3b-887d-3499cb200d3c.jpg" },
                new Turebi { id = 7, Name = "Denmark", Description = "მაგარიი პონტიიი", Price = 19000, image_name = "f521cee9-6c84-4a02-8f75-9800f0002a53.jpg" },
                new Turebi { id = 8, Name = "Spain", Description = "მაგარიი პონტიიი", Price = 23000, image_name = "6d4ea991-f9a5-4ec6-8550-0e4e02e5ab4c.jpg" }
                );
                        }
    }
}
