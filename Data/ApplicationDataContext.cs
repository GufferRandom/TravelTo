...
namespace TravelTo.Data
{
    public class ApplicationDataContext:IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
		  ...
		  new Sastumroebi { Id = 1, Lokacia = "Robotiqsi", Fasi = 100, Description = "es sastumro mdebareobs dedamiwis mwervalze romelzedac iyo guini", gmail = "gmail@gmail.com", Name = "Robotiqsi Grand Hotel" },
		  new Sastumroebi { Id = 2, Lokacia = "Antarqtida", Fasi = 50, Description = "Es sastumro mdebareobs msoflios yvelaze civ wertislhi wesit esaaa", gmail = "antarqtida@gmail.com", Name = "Antarqtida Luxury Suites" },
		  new Sastumroebi { Id = 3, Lokacia = "Tbilisi", Fasi = 75, Description = "Tbilisi tbilisi tbilisi uni uni uni btu ilia japan tsu.", gmail = "tbilisi@gmail.com", Name = "Tbilisi City Hotel" },
		  new Sastumroebi { Id = 4, Lokacia = "Kutaisi", Fasi = 60, Description = "Kutaisi kutaisi kutaisi ratqmaunda kutasisi rogorc yoveltvbis kutaisi.", gmail = "kutaisi@gmail.com", Name = "Kutaisi Boutique Hotel" },
		  new Sastumroebi { Id = 5, Lokacia = "Batumi", Fasi = 80, Description = "Batumi bautmi bautmi zfgva zgva zgva meti meti meti.", gmail = "batumi@gmail.com", Name = "Batumi Beach Resort" },
		  new Sastumroebi { Id = 6, Lokacia = "Mtskheta", Fasi = 40, Description = "Mtskheta es xom mcxetaa mcxetaa azrze ar var ra davwero amaze.", gmail = "mtskheta@gmail.com", Name = "Mtskheta Heritage Inn" },
		  new Sastumroebi { Id = 7, Lokacia = "Zugdidi", Fasi = 30, Description = "Zugdidi es xom zugdidia yvelaze didi farti romelic daixarja", gmail = "zugdidi@gmail.com", Name = "Zugdidi Park Hotel" },
		  new Sastumroebi { Id = 8, Lokacia = "Gori", Fasi = 45, Description = "Gori gori gori amis meti ra unda vtqva es xom goria gorta shoris.", gmail = "gori@gmail.com", Name = "Gori Fortress Hotel" },
		  new Sastumroebi { Id = 9, Lokacia = "Telavi", Fasi = 55, Description = "Telavi telavi telavi azrze ar var ra davwero amashi mara telaviaMountains.", gmail = "telavi@gmail.com", Name = "Telavi Wine Hotel" },
		  new Sastumroebi { Id = 10, Lokacia = "Signagi", Fasi = 65, Description = "Signagi signagi signagi es xom signagia azrze ar var ra davwero amazec amitomac signagi signagia.", gmail = "signagi@gmail.com", Name = "Signagi Hilltop Hotel" }
	  );
