    ...
    public class ApplicationDataContext:IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Turebi>().HasData(
                new Turebi
                {
                    id = 1, Name = "ანტარქტიდა", Description = "ანტარქტიდა დედამიწის ყველაზე სამხრეთული კონტინენტია, სადაც არ არსებობს მუდმივი მოსახლეობა, მხოლოდ მკვლევარები.",
                    Price = 999.99, image_name = "antarqtida.jpg", Company_Id = 1
                },
                new Turebi
                {
                    id = 2, Name = "თბილისი", Description = "თბილისი საქართველოს დედაქალაქია, ცნობილია თავისი ისტორიული ძველი უბნებით და კულტურული მნიშვნელობით.",
                    Price = 500.99, image_name = "Tbilisi.jpg", Company_Id = 3
                },
                new Turebi
                {
                    id = 3, Name = "ქუთაისი", Description = "ქუთაისი საქართველოს ისტორიული ქალაქია, გალიას საკათედრო ტაძრითა და მსოფლიოს ერთ-ერთი ძველი უნივერსიტეტით.",
                    Price = 799.99, image_name = "7012519385_f7e92b8d8e_z.jpg", Company_Id = 2
                },
                new Turebi
                {
                    id = 4, Name = "პარიზი", Description = "პარიზი საფრანგეთის დედაქალაქია, ცნობილია აიფელის კოშკით და ლუვრის მუზეუმით.",
                    Price = 1999.99, image_name = "Spain.jfif", Company_Id = 4
                },
                new Turebi
                {
                    id = 5, Name = "ბათუმი", Description = "ბათუმი შავი ზღვის სანაპიროზე მდებარე ქალაქია, ცნობილი თავისი სანაპირო პარკებით და კურორტებით.",
                    Price = 999.99, image_name = "Batumi.jpg", Company_Id = 1
                },
                new Turebi
                {
                    id = 6, Name = "მაიამი", Description = "მაიამი, აშშ-ის ფლორიდაში მდებარე ქალაქია, ცნობილი თავისი ფინანსური, კულტურული და სავაჭრო ცენტრის როლით.",
                    Price = 1999.99, image_name = "Brazil.jfif", Company_Id = 2
                },
                new Turebi
                {
                    id = 7, Name = "გორი", Description = "გორი ქალაქია საქართველოში, ცნობილია თავისი ისტორიული მნიშვნელობით და გორის ციხით.",
                    Price = 500.99, image_name = "Denmark.jfif", Company_Id = 4
                },
                new Turebi
                {
                    id = 8, Name = "თელავი", Description = "თელავი ქალაქია კახეთში, ცნობილი თავისი ღვინის კულტურით და ისტორიული ძეგლებით.",
                    Price = 999.99, image_name = "Los-AngelesCa.jfif", Company_Id = 3
                }
            );
modelBuilder.Entity<Sastumroebi>().HasData(
    new Sastumroebi
    {
        Id = 1, Lokacia = "თბილისი", Fasi = 100,
        Description = "ეს სასტუმრო წარმოადგენს სამგზის ლუქსს და თანამედროვე მომსახურებას.",
        gmail = "tbilisi@gmail.com", Name = "თბილისის ცენტრალური სასტუმრო", image_name = "1.jpeg", Tviseba_Id = 1
    },
    new Sastumroebi
    {
        Id = 2, Lokacia = "ბათუმი", Fasi = 50,
        Description = "ამ სასტუმროში სტუმრები სარგებლობენ საოცარი სანაპიროს ხედებით.",
        gmail = "batumi@gmail.com", Name = "ბათუმი რეზორტი", image_name = "2.jpg", Tviseba_Id = 2
    },
    new Sastumroebi
    {
        Id = 3, Lokacia = "ქუთაისი", Fasi = 75,
        Description = "სასტუმრო გთავაზობთ კომფორტულ პირობებს და შესანიშნავ სამზარეულოს.",
        gmail = "kutaisi@gmail.com", Name = "ქუთაისი  სასტუმრო", image_name = "3.jpg", Tviseba_Id = 3
    },
    new Sastumroebi
    {
        Id = 4, Lokacia = "მცხეთა", Fasi = 60,
        Description = "სასტუმრო წარმოადგენს ისტორიულ და კულტურულ გარემოს.",
        gmail = "mtskheta@gmail.com", Name = "მცხეთა ჰერიტიჯ სასტუმრო", image_name = "4.webp", Tviseba_Id = 4
    },
    new Sastumroebi
    {
        Id = 5, Lokacia = "ზუგდიდი", Fasi = 80,
        Description = "ცენტრალური ადგილმდებარეობა, ახლოს სამრეწველო და კულტურული ატრაქციონებთან.",
        gmail = "zugdidi@gmail.com", Name = "ზუგდიდი პარკ სასტუმრო", image_name = "5.jpg", Tviseba_Id = 5
    },
    new Sastumroebi
    {
        Id = 6, Lokacia = "გორი", Fasi = 40,
        Description = "მომსახურება მაღალი ხარისხის, მყუდრო ატმოსფერო და თანამედროვე ოთახები.",
        gmail = "gori@gmail.com", Name = "გორი ფორტეს სასტუმრო", image_name = "6.jpg", Tviseba_Id = 6
    },
    new Sastumroebi
    {
        Id = 7, Lokacia = "თელავი", Fasi = 30,
        Description = "თელავში მდებარე მყუდრო სასტუმრო, რომელიც გთავაზობთ შესანიშნავ მომსახურებას.",
        gmail = "telavi@gmail.com", Name = "თელავი უაინ ჰოტელი", image_name = "7.jpg", Tviseba_Id = 7
    },
    new Sastumroebi
    {
        Id = 8, Lokacia = "სიღნაღი", Fasi = 45,
        Description = "სასტუმრო მაღალი ხარისხის მომსახურებითა და ლამაზი ხედებით.",
        gmail = "signagi@gmail.com", Name = "სიღნაღი ჰილტოპ სასტუმრო", image_name = "8.jpg", Tviseba_Id = 8
    },
    new Sastumroebi
    {
        Id = 9, Lokacia = "რაჭა", Fasi = 55,
        Description = "სასტუმრო მშვიდ გარემოში და სრულყოფილი მყუდროებით.",
        gmail = "racha@gmail.com", Name = "რაჭა რეზორტი", image_name = "9.jpg", Tviseba_Id = 9
    },
    new Sastumroebi
    {
        Id = 10, Lokacia = "ვარძი", Fasi = 65,
        Description = "ვარძი ჰოტელი გთავაზობთ თანამედროვე ფასის ოპციებს და განსაცვიფრებელ გარემოს.",
        gmail = "vardzi@gmail.com", Name = "ვარძი რეზორტი", image_name = "10.jpg", Tviseba_Id = 10
    }
);
